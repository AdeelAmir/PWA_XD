      ...
      <div class="h-100" style="background-color: #c6ced5;">
        ...
        <div style="background-color: #f6f9fa !important; padding-top: 20px;" class="navigationbar">
          <ul id="links" class="list-group" onclick="closeSideDrawer()" style="background-color: #f6f9fa !important">
            <a style="background-color: #f6f9fa !important; padding-left: 30px;" id="link-structure" href="#" class="list-group-item list-group-item-action border-0 rounded-0"><img src="assets/images/howtouse_active.png"><span style="padding-left: 18px;font-size:13px;color: #000000;"><strong>HOW TO USE?</strong></span></a>
